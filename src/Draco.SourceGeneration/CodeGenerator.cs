...
internal static class CodeGenerator
{
    ...
    public static string GenerateRedGreenAssociations(SyntaxTree.Tree tree, CancellationToken cancellationToken) =>
        Render("RedGreenAssociations.sbncs", tree, cancellationToken);
